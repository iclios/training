window.J1_BLOCS = [
  ...
  { id: "authentification", title: "Authentification", href: "authentification.html" },
...
(function initJ1Nav() {
  ...
  if (sidebar) {
    ...
    heading.textContent = "Jour 1";

    const list = document.createElement("nav");
    list.className = "bloc-sidebar-nav";
    list.setAttribute("aria-label", "Blocs du jour 1");
  ...
  if (blockMap) {
    blockMap.innerHTML = "";
    blocs.forEach((bloc) => {
      const a = document.createElement(bloc.href ? "a" : "a");
      a.href = bloc.href || "#";
